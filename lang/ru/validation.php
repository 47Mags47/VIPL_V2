...
return [
    ...
    */
    ...
    'between' => [
        'array' => 'Кол-во элементов в поле ":attribute" должно быть от :min до :max.',
        'file' => 'Размер файла в поле ":attribute" должен быть от :min до :max Кб.',
        'numeric' => 'Значение поля ":attribute" должно быть от :min до :max.',
        'string' => 'Кол-во символов в поле ":attribute" должно быть от :min до :max.',
    ],
    ...
    'digits' => 'Кол-во символов в поле ":attribute" должно быть равным :digits.',
    'digits_between' => 'Кол-во символов в поле ":attribute" должно быть от :min до :max.',
    ...
    'gt' => [
        'array' => 'Кол-во элементов в поле ":attribute" должно быть больше :value.',
        ...
        'string' => 'Кол-во символов в поле ":attribute" должно быть больше :value.',
    ],
    'gte' => [
        'array' => 'Кол-во элементов в поле ":attribute" должно быть :value или больше.',
        ...
        'string' => 'Кол-во символов в поле ":attribute" должно быть :value или больше.',
    ],
    ...
    'lt' => [
        'array' => 'Кол-во элементов в поле ":attribute" должно быть меньше :value.',
        ...
        'string' => 'Кол-во символов в поле ":attribute" должно быть меньше :value.',
    ],
    'lte' => [
        'array' => 'Кол-во элементов в поле ":attribute" должно быть :value или меньше.',
        ...
        'string' => 'Кол-во символов в поле ":attribute" должно быть :value или меньше.',
    ],
    'mac_address' => 'Значение поля ":attribute" должно быть корректным MAC-адресом.',
    'max' => [
        'array' => 'Кол-во элементов в поле ":attribute" не может превышать :max.',
        'file' => 'Размер файла в поле ":attribute" не может быть больше :max Кб.',
        'numeric' => 'Значение поля ":attribute" не может быть больше :max.',
        'string' => 'Кол-во символов в значении поля ":attribute" не может превышать :max.',
    ],
    ...
    'min' => [
        'array' => 'Кол-во элементов в поле ":attribute" должно быть не меньше :min.',
        ...
        'string' => 'Кол-во символов в поле ":attribute" должно быть не меньше :min.',
    ],
    ...
    'required_without' => 'Поле ":attribute" обязательно, когда поле ":values" пусто.',
    'required_without_all' => 'Поле ":attribute" обязательно для заполнения, когда ни одно из :values не указано.',
    'same' => 'Значения полей ":attribute" и :other должны совпадать.',
    'size' => [
        'array' => 'Кол-во элементов в поле ":attribute" должно быть равным :size.',
        'file' => 'Размер файла, указанный в поле ":attribute", должен быть равен :size Кб.',
        'numeric' => 'Значение поля ":attribute" должно быть равным :size.',
        'string' => 'Кол-во символов в поле ":attribute" должно быть равным :size.',
    ],
    ...
    */
    ...
    'custom' => [
        'column.*' => [
            'distinct' => 'Значения поля ":attribute" должно быть уникальным',
        ],
    ],
    'values' => [
        'date' => [
    ...
    */
    ...
    'attributes' => [
        ...
        'column.1' => 'Имя столбца 1',
        'column.2' => 'Имя столбца 2',
        'column.3' => 'Имя столбца 3',
        'column.4' => 'Имя столбца 4',
        'column.5' => 'Имя столбца 5',
        'column.6' => 'Имя столбца 6',
        'column.7' => 'Имя столбца 7',
        'column.8' => 'Имя столбца 8',
        'column.9' => 'Имя столбца 9',
        'column.10' => 'Имя столбца 10',
    ],
